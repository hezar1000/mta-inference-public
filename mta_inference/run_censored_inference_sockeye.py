...
import censored_model_inference
...
if __name__ == "__main__":
    ...
    # model changes
    parser.add_argument('--disable_efforts', action='store_true') # clamp all efforts to 1
    ...
    # Clamp zombies: TODO: zombies + database
    ...
    true_grades_gibbs, efforts_gibbs, reliabilities_gibbs, effort_draws_gibbs = censored_model_inference.run_gibbs(
